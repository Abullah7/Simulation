...
alpha=float(input("Enter the Chi square value from the table: "))
...
for i in range(len(RD)):
     if i+1>= len(RD):
          break
     print(" the 2 RDs "+str(RD[i])+" "+str(RD[i+1]))   
     if 0.33>=RD[i]>0 and 0.33>=RD[i+1]>0:
         O1=O1+1

     elif 0.67>=RD[i]>0.33 and 0.33>=RD[i+1]>0:
         O2=O2+1
     elif 1>=RD[i]>0.67 and 0.33>=RD[i+1]>0:
         O3=O3+1
     elif 0.33>=RD[i]>0 and 0.67>=RD[i+1]>0.33:
          O4=O4+1
     elif 0.67>=RD[i]>0.33 and 0.67>=RD[i+1]>0.33:
          O5=O5+1
          print("O5 = "+str(O5))
     elif 1>=RD[i]>0.67 and 0.67>=RD[i+1]>0.33:
          O6=O6+1
          print("O6 = "+str(O6))          
     elif 0.33>=RD[i]>0 and 1>=RD[i+1]>0.67:
          O7=O7+1
     elif 0.67>=RD[i]>0.33 and 1>=RD[i+1]>0.67:
          O8=O8+1
     elif 1>=RD[i]>0.67 and 1>=RD[i+1]>0.67:
          O9=O9+1
     else:
...
for i in range(len(O)):
     ...
     #printing sum of ((O[i]-Ei)^2)/Ei
        sumPow=sumPow+f
        #note that in O5 and O6 is not the same as pdf because of the '=' in the intervals ,the two pairs(0.67,0.36) 
